...
import { searchPeople, addGroupMember } from "@/lib/actions/groups";

export function AddGroupMemberWidget({ groupId }: { groupId: string }) {
  ...
  function handleAdd(personId: string) {
    startTransition(async () => {
      await addGroupMember(groupId, personId, role);
      setQuery("");
      setResults([]);
    });
  }
